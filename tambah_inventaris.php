                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal" method="post" action="proses_tambah_inventaris.php">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="tgl_datang" name="tgl_datang" type="date">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="status_barang" id="status_barang1" value="Baik">
                                                    Baik
                                                </label>
                                                <label>
                                                    <input type="radio" name="status_barang" id="status_barang2" value="Perawatan">
                                                    Perawatan
                                                </label>
                                                <label>
                                                    <input type="radio" name="status_barang" id="status_barang2" value="Rusak">
                                                    Rusak
                                                </label>
                                            </div>
                                        </div>
