...
<!DOCTYPE html>
<head>
<title>Kategori Alat Tulis Kantor</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a class="active" href="list_alat_tulis.php">Alat Tulis Kantor</a></li>
    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
          <?php
            include 'koneksi.php';
            $query = mysqli_query($konek, "SELECT * FROM inventaris WHERE kategori IN ('Alat Tulis Kantor')");
            $nomor = 0;
            $total_harga = 0;
            $total_inventaris = 0;
